                  ...
                  <div>
                    ...
                    <form @submit.prevent="saveRole()">
                        ...
                        <div class="form-group">
                            ...
                            <select v-model="role.role_name" class="form-control" id="role">
                            <option>Admin</option>
                            <option>User</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <input v-model="role.description" type="text" class="form-control">
                        </div>
...
export default {
    ...
    setup(props) {
        ...
        const { errors, getRole, role, updateRole, logout } = useUser()
